    ...
    <div className="space-y-6">
      ...
      <section className="space-y-3 rounded-2xl border bg-card p-5">
        ...
        <p className="text-xs text-muted-foreground">
          Íconos disponibles: baby, car, bed, milk, monitor, puzzle, shirt, backpack, bath, package. Desactivar una
          categoría la oculta del catálogo y del formulario de venta (sus productos siguen existiendo).
        </p>
