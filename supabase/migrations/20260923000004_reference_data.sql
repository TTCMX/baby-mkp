...
-- The Supabase GitHub integration only runs seed.sql on local/preview branches,
-- so anything the app needs to work lives here. Idempotent: safe to re-run.
-- Later changes to these values are made from the admin panel, not here.
-- =============================================================================
